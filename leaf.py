...
filepath = 'C:/Users/DELL/PycharmProjects/PoTo-disease/model.h5'
...
def pred_potato_dieas(potato_plant):
    ...
    if pred == 0:
        ...
        return "Potato - Late Blight Disease", 'Potato - Late_blight.html'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('C:/Users/DELL/PycharmProjects/PoTo-disease/static/upload/', filename)
        file.save(file_path)
